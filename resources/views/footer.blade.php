        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <p class="stext-107 cl7 size-201">
                    Any questions? Let us know at Instagram or Facebook or give us a call at (+84) 852016065
                </p>
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <form>
                    <div class="wrap-input1 w-full p-b-4">
                        <input class="input1 bg-none plh1 stext-107 cl7" type="text" name="email" placeholder="decichic@gmail.com">
        ...
        <div class="p-t-40">
            <div class="flex-c-m flex-w p-b-18">
                <a href="#" class="m-all-1">
                    <img src="images/icons/icon-pay-06.png" alt="Apple Pay">
                </a>

                <a href="#" class="m-all-1">
                    <img src="images/icons/icon-pay-07.png" alt="Credit Card">
                </a>

                <a href="#" class="m-all-1">
                    <img src="images/icons/icon-pay-08.png" alt="PayPal">
                </a>

                <a href="#" class="m-all-1">
                    <img src="images/icons/icon-pay-09.png" alt="Master Card">
                </a>

                <a href="#" class="m-all-1">
                    <img src="images/icons/icon-pay-010.png" alt="Visa Card">
                </a>
            </div>
